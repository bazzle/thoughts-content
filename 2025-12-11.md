...
<ShowcaseViewer>
	<BrowserFrame src="satoshi-power-mobile.png" alt="Satoshi Power Screenshot" caption="Currency index" mobile />
	<BrowserFrame src="satoshi-power-mobile2.png" alt="Satoshi Power Screenshot" caption="Sat to fiat conversion" mobile />
	<BrowserFrame src="satoshi-power-mobile5.png" alt="Satoshi Power Screenshot" caption="Output in localised format" mobile />
	<BrowserFrame src="satoshi-power-mobile4.png" alt="Satoshi Power Screenshot" caption="... or fiat to sats" mobile />
</ShowcaseViewer>
