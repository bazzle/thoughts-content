...
* Rebuilt [Satoshi Power](https://satoshi-power.com/) in Next.js. Have some plans in mind for that website, so wrote up a roadmap on the readme for the project.
* Doing dead-hangs daily, along with my press-ups. Can manage 45 seconds. Feel the limiting factor is the lack of strength in my fingers.
* Started my second read through of Hitch-hikers Guide to the Galaxy. Apparently jumping into hyperspace is unpleasant, like getting drunk—if you're wondering why getting drunk should be unpleasant, ask a glass of water. 😂
