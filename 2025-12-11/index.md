...
<h2 id="dedicated-currency-screen-with-converter-tool">Dedicated currency screen with converter tool</h2>

<ShowcaseViewer>
	<BrowserFrame src="satoshi-power-mobile.png" alt="Satoshi Power Screenshot" caption="Currency index" type="mobile" />
	<BrowserFrame src="satoshi-power-mobile2.png" alt="Satoshi Power Screenshot" caption="Sat to fiat conversion" type="mobile" />
	<BrowserFrame src="satoshi-power-mobile5.png" alt="Satoshi Power Screenshot" caption="Output in localised format" type="mobile" />
	<BrowserFrame src="satoshi-power-mobile4.png" alt="Satoshi Power Screenshot" caption="... or fiat to sats" type="mobile" />
</ShowcaseViewer>
