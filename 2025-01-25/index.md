...
<div className="article-images article-images--2 extended">
	<PostImage src="htg-homepage-full.png" alt="Help to Grow homepage" caption="Help to Grow homepage" />
	<PostImage src="htg-landing-full.png" alt="Help to Grow landing page" caption="Help to Grow landing page" />
</div>
...
<ShowcaseViewer>
	<BrowserFrame src="htg-hero.png" alt="BFI website Screenshot" caption="Landing page" />
	<BrowserFrame src="htg-hero-mobile.png" alt="BFI website navigation Screenshot" caption="Landing page header and hero" type="mobile" />
	<BrowserFrame src="htg-menu-open-mobile.png" alt="BFI website navigation Screenshot" caption="Mobile navigation menu expanded" type="mobile" />
</ShowcaseViewer>
...
<ShowcaseViewer>
	<BrowserFrame src="htg-cards.png" alt="Help to Grow website Screenshot" caption="Cards" />
	<BrowserFrame src="htg-cards2.png" alt="Help to Grow website navigation Screenshot" caption="Reversed background colour cards, one linking to external source" />
	<BrowserFrame src="htg-cards-mobile.png" alt="Help to Grow website navigation Screenshot" caption="Mobile width" type="mobile" />
</ShowcaseViewer>

<ShowcaseViewer>
	<BrowserFrame src="htg-cta-links.png" alt="Help to Grow website Screenshot" caption="Call to actions" />
	<BrowserFrame src="htg-cta-links-mobile.png" alt="Help to Grow website Screenshot" caption="CTA's on mobile" type="mobile" />
</ShowcaseViewer>
